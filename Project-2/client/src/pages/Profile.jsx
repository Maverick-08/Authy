...
const RenderTimeLeft = ({ time }) => {
  if (time < 0) {
    ...
    return (<span className="rounded-md bg-red-400 border-2 border-red-500 text-xl text-black flex justify-center items-center px-4 py-2">
    {time} s
  </span>)
  }
  else if (time < 120){
    return (<span className="rounded-md bg-yellow-300 border-2 border-yellow-500 text-xl text-black flex justify-center items-center px-4 py-2">
      {time} s
    </span>)
  }
  else{
    return (<div className="w-32 h-12  rounded-md bg-green-300 border-2 border-green-400 text-xl text-black flex justify-center items-center px-4 py-2">
      {time} s
    </div>)
  }
};
