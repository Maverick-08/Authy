      ...
      >
        <div className="w-full flex flex-col gap-24 justify-center items-center pt-24">
          ...
          <div className="w-[80vw] flex gap-24 items-center">
            ...
            <p className="text-2xl text-gray-400 leading-10">Heyy Everyone ! My name is <span className="text-gray-600 font-semibold">Vivek Ojha</span>. I am a 2nd year grad at <span className="text-gray-600 font-semibold">NIT Bhopal</span>. I am a software developer with an expertise in <span className="text-gray-600 font-semibold">MERN stack, Flask, Tailwind Css, React Native and AWS.</span> I describe myself as a learner who follows the idea of choosing <span className="text-gray-600 font-semibold">progress over perfection !</span> This ideology keeps me going to <span className="text-gray-600 font-semibold">learn new stuff</span> and figuring out a way to <span className="text-gray-600 font-semibold">implement</span> it in native projects!</p>
          </div>
        </div>
      </div>
    </div>
